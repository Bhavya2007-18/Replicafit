...
const exercises = [
  ...
  { name: 'Lunges', targetMuscles: ['Quadriceps', 'Hamstrings', 'Glutes', 'Calves'], difficulty: 'Beginner', category: 'strength', instructions: ['Stand tall, feet hip-width apart.', 'Step forward with right leg.', 'Lower until right thigh is parallel to floor.', 'Push off to return. Repeat other side.'], commonMistakes: ['Front knee past toes.', 'Leaning torso too far forward.', 'Step too short.'] },
  { name: 'Pullups', targetMuscles: ['Latissimus Dorsi', 'Biceps', 'Upper Back', 'Core'], difficulty: 'Advanced', category: 'strength', instructions: ['Grip bar, palms away, wider than shoulders.', 'Hang with arms extended.', 'Pull up until chin clears bar.', 'Lower with control.'], commonMistakes: ['Using momentum (kipping).', 'Incomplete range of motion.', 'Shoulders shrugging to ears.'] },
  { name: 'Plank', targetMuscles: ['Core', 'Shoulders', 'Back'], difficulty: 'Beginner', category: 'strength', instructions: ['Start on forearms and toes.', 'Elbows under shoulders.', 'Straight line from head to heels.', 'Hold while bracing core.'], commonMistakes: ['Hips too high.', 'Hips sagging.', 'Straining neck.'] },
  { name: 'Leg Raises', targetMuscles: ['Lower Abs', 'Hip Flexors'], difficulty: 'Intermediate', category: 'strength', instructions: ['Lie flat, legs straight together.', 'Arms by sides or under lower back.', 'Lift legs to ceiling, keep straight.', 'Lower without touching floor.'], commonMistakes: ['Arching lower back.', 'Using momentum.', 'Bending knees.'] },
];
